...
<body>
    <div id="wrapper">
        <4 class="navbar navbar-default top-navbar" role="navigation">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="{{ URL('halaman') }}" class="active-menu" ><i class="fa fa-dashboard"></i> Dashboard</a>
                    </li>
                    <li>
                        <a href="#" ><i class="fa fa-desktop"></i> Kelas</a>
                    </li>
                    <li>
                        <a href="#" ><i class="fa fa-bar-chart-o"></i> Profil</a>
                    </li>
