    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ URL('halaman') }}"><i class="fa fa-cube"></i> <strong>Kubik Academy </strong></a>
            </div>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="#" ><i class="fa fa-desktop" class="active-menu"></i> Kelas</a>
                    </li>
                    <li>
                        <a href="{{URL('profile')}}" ><i class="fa fa-bar-chart-o"></i> Profil</a>
                    </li>
