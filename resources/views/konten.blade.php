        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="{{ URL('admin/kelas') }}"><i class="fa fa-desktop"></i> Daftar Kelas</a>
                    </li>
                    <li>
                        <a href="{{ URL('admin/users') }}"><i class="fa fa-bar-chart-o"></i> Daftar User</a>
                    </li>
                    <li>
                        <a href="{{ URL('admin/konten')}}" class="active-menu"><i class="fa fa-qrcode"></i> Konten Online</a>
                    </li>
            ...
            <div id="page-inner">
             <div class="row">
                  ...
                  <form action="upload" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <h1>Upload file untuk peserta</h1>
                    <table>
                      <tr><td><br/></td></tr>
                      <tr>
                        <td>Nama file</td>
